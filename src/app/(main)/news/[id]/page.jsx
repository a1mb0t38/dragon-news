                ...
                <div className="card-body">
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <Link href={`/category/${news.category_id}`}>
                            <button className='btn bg-purple-500 text-white flex items-center'>See other News for this category<BsArrowRight></BsArrowRight></button>
                        </Link>
                    </div>
                </div>
            </div>
